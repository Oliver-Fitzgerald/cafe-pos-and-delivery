...
public final class ReceiptPrinter {
    ...
    public String format(Order order, PricingService.PricingResult pricingResult) {

        StringBuilder receipt = new StringBuilder();
        receipt.append("Order (").append(order.id()).append(") x").append(order.items().size()).append("\n");
        receipt.append("Subtotal: ").append(pricingResult.subtotal()).append("\n");

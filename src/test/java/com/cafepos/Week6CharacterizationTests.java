...
public class Week6CharacterizationTests {
    ...
    @Test void no_discount_cash_payment() {
        String receipt = OrderManagerGod.process("ESP+SHOT+OAT", 1, "CASH", new NoDiscount(), new FixedRateTaxPolicy(10), false);
    ...
    @Test void loyalty_discount_card_payment() {
        ...
        String receipt = OrderManagerGod.process("LAT+L", 2, "CARD", new LoyaltyPercentDiscount(5), new FixedRateTaxPolicy(10), false);
    ...
    @Test void coupon_fixed_amount_and_qty_clamp() {
            String receipt = OrderManagerGod.process("ESP+SHOT", 0, "WALLET", new FixedCouponDiscount(Money.of(1)), new FixedRateTaxPolicy(10), false);
